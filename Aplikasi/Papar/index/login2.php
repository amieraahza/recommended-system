...
<!-- Meta tag Keywords -->
<!-- css files -->
<link href="<?php echo URL ?>sumber/rangka-dawai/one-page-wonder/css/style.css" rel="stylesheet" type="text/css" media="all">
	...
	<h2 class="sub-head">Log In</h2>
		<div class="sub-main">	
			<form action="<?php echo URL?>login/checkid" method="POST">
				...
				<input  placeholder="Password" name="biodata[0][password]" type="password" required="">
