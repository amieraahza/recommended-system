  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome User</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        ...
        <li class="divider"></li>
        <li><a href="<?php echo URL ?>homeadmin/login"><i class="icon-key"></i> Log Out</a></li>
      </ul>
    </li>
    ...
    <li class=""><a title="" href="<?php echo URL ?>homeadmin/login"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
  </ul>
</div>
