...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Form</a> <a href="#" class="current">Category</a> </div>
  <h1>Category</h1>
</div>
...
<?php include 'include/footer2.php'; ?><!--Header-part-->
<div id="header">
